...
console.log(input);
if(Date.parse(input)){//condion to check wether the date is valid or nt
var inputdate=new Date(input);//standard format
...
dd.innerHTML=`date is :${inputdate} <br>
year : ${yeardiff} <br>
month: ${monthdiff} <br>
day : ${daydiff} <br>
hours : ${hourdiff} <br>
...
milliseconds: ${millisecondsdiff}`;
    ...
    dd.innerHTML="<h1>invalid date<h1>";
}
